...
excerpt: Build autonomous-driving capabilities on a 1:20 RC car
date: 2018-09-25
image: project_autocar.jpg
author: Ruixiang Du
caption: Initial setup of the RC car.
published: true
featured: true
tags:
  - RC Car
...
This project is aimed at building and maintaining a 1:20 RC-car based mobile platform that can be used for study and experimentation on new ideas about autonomous driving. Though it's fun and may appear more exciting to show complete autonomous navigation capabilities, I would not take it as the top priority and the platform is ecptected to undergo frequent changes to meet the needs of trying out a specific hardware or software piece.
